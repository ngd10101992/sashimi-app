...
function Modal(props, ref) {
  ...
  return (
    <>
      {open && <div ref={modalRef} className="animate-fade backdrop-blur-sm bg-slate-900/20 pt-20 w-screen h-screen fixed top-0 left-0" style={{zIndex: 999}}>
        <div className="absolute top-0 left-0 w-full h-full" onClick={close} />
        <div className={`${width} bg-white dark:bg-slate-800 rounded-md drop-shadow-2xl mx-auto`}>
          ...
          <footer className="flex items-center justify-between px-4 w-full h-16 border-t border-slate-200 dark:border-slate-700">
